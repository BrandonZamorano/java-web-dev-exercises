...
public class AliceExtended {
    public static void main(String[] args) {
        ...
        int searchIndex = sentence.toLowerCase().indexOf(searchTerm);
        if (searchIndex >= 0) {
            System.out.printf("%s was found at index %d with a length of %d!", searchTerm, searchIndex, 1);

        } else {
            System.out.printf("%s was not found!", searchTerm);
